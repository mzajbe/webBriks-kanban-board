...
const COLUMN_STYLES = [
  {
    dotColor: "bg-[#1b4332] dark:bg-emerald-500",
    bgTint: "bg-emerald-50/40 dark:bg-emerald-950/20",
    borderTint: "border-emerald-200/80 dark:border-emerald-900/40",
  ...
  },
  {
    ...
    borderTint: "border-amber-200/80 dark:border-amber-900/40",
  ...
  },
  {
    ...
    borderTint: "border-blue-200/80 dark:border-blue-900/40",
  ...
  },
  {
    ...
    borderTint: "border-purple-200/80 dark:border-purple-900/40",
    badgeBg: "bg-purple-100 dark:bg-purple-950/80",
    badgeText: "text-purple-800 dark:text-purple-300",
  },
  {
    dotColor: "bg-rose-500 dark:bg-rose-400",
    bgTint: "bg-rose-50/40 dark:bg-rose-950/20",
    borderTint: "border-rose-200/80 dark:border-rose-900/40",
  ...
  },
  {
    ...
    borderTint: "border-indigo-200/80 dark:border-indigo-900/40",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        style.bgTint,
        style.borderTint,
        highlighted && "ring-2 ring-emerald-500/60 bg-emerald-50/80 dark:bg-emerald-950/40 shadow-md"
      )}
    >
      {/* Column Header */}
      ...
      <SortableContext items={tasks.map((t) => t.id)} strategy={verticalListSortingStrategy}>
        <div className="flex-1 space-y-3 min-h-[320px]">
          {tasks.length === 0 ? (
            <div className="flex h-48 flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200/90 bg-white/40 dark:border-slate-800/90 dark:bg-slate-900/30 p-4 text-center">
              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400">No tasks</p>
              <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">Drag tasks here</p>
            </div>
          ) : (
            tasks.map((task) => (
              <SortableTaskCard
